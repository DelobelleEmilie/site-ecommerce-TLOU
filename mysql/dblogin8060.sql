...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 13 fév. 2023 à 08:26
...
CREATE TABLE IF NOT EXISTS `shop_commande` (
    ...
    `label_produit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
    `prix` int NOT NULL,
    `label_adresse` int NOT NULL,
    PRIMARY KEY (`Id`),
    KEY `IdAdresse` (`label_adresse`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Contraintes pour la table `shop_commande`
--
ALTER TABLE `shop_commande`
    ADD CONSTRAINT `IdAdresse` FOREIGN KEY (`label_adresse`) REFERENCES `shop_adresse` (`idshop_adresse`) ON DELETE RESTRICT ON UPDATE RESTRICT;
